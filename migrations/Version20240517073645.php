 ...
 */
final class Version20240517073645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auth_user (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', customer_id INT NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_LOGIN (login), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cst_customer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ord_fixed_address (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, external_id VARCHAR(100) NOT NULL, name_company_or_person VARCHAR(250) NOT NULL, address VARCHAR(250) NOT NULL, city VARCHAR(250) NOT NULL, zip_code VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ord_order_line (id INT AUTO_INCREMENT NOT NULL, order_id INT NOT NULL, customer_id INT NOT NULL, quantity INT NOT NULL, length INT NOT NULL, width INT NOT NULL, height INT NOT NULL, weight_one_pallet INT NOT NULL, weight_total INT NOT NULL, goods_description VARCHAR(250) NOT NULL, INDEX IDX_6E2713D58D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ord_order_sscc (id INT AUTO_INCREMENT NOT NULL, order_id INT NOT NULL, customer_id INT NOT NULL, code BIGINT NOT NULL, INDEX IDX_2B21A9C28D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
