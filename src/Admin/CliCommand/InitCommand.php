...
class InitCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->ex("
            ...
            VALUES (1, 2, '12', 'NEW', 4, 'Acme Company', 'ul. Garbary 125', 'Poznań', '61-719', 'Contact Person', '+44-000-000-000', 'person@email.com', 'Receiver Company', 'ul. Wschodnia', 'Poznań', '61-001', 'Person2', '+48-111-111-111', NULL)");
