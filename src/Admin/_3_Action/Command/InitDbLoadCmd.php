...
class InitDbLoadCmd implements InitDbLoadInterface
{
    ...
    public function initDbLoad(): void
    {
        ...
        $this->ex("INSERT INTO cst_customer (id, version, name) VALUES(1, 1, 'System owner')");
        $this->ex("INSERT INTO cst_customer (id, version, name) VALUES(2, 1, 'Acme Company')");
        ...
        $this->ex("
            INSERT INTO ord_fixed_address (id, customer_id, version, external_id, name_company_or_person, address, city, zip_code) 
            VALUES(1, 2, 1, 'HQ', 'Acme Company', 'ul. Garbary 125', 'Poznań', '61-719')");

        $this->ex("
            INSERT INTO ord_order (id, customer_id, version, number, status, quantity_total, loading_date, loading_name_company_or_person, loading_address, loading_city, loading_zip_code, loading_contact_person, loading_contact_phone, loading_contact_email, loading_fixed_address_external_id, delivery_name_company_or_person, delivery_address, delivery_city, delivery_zip_code, delivery_contact_person, delivery_contact_phone, delivery_contact_email) 
            VALUES (1, 2, 1, '12', 'NEW', 4, '2024-5-29', 'Acme Company', 'ul. Garbary 125', 'Poznań', '61-719', 'Contact Person', '+44-000-000-000', 'person@email.com', 'HQ', 'Receiver Company', 'ul. Wschodnia', 'Poznań', '61-001', 'Person2', '+48-111-111-111', NULL)");
